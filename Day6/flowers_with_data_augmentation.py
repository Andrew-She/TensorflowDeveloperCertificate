...
train_data_gen = ImageDataGenerator(rescale = 1.0/255.,
                               horizontal_flip = True).flow_from_directory(val_dir,
                                                                           target_size=IMG_SHAPE,
                                                                           batch_size=batch_size,
                                                                           shuffle=True,
                                                                           class_mode='categorical')
...
image_gen = ImageDataGenerator(rescale=1.0/255.,
                               rotation_range=45).flow_from_directory(train_dir,batch_size=batch_size,target_size=IMG_SHAPE,
                                                                shuffle=True,class_mode='categorical')

train_data_gen = ImageDataGenerator(rescale=1.0/255.,rotation_range=45).flow_from_directory(val_dir,batch_size=batch_size,
                                                                                            target_size=IMG_SHAPE,shuffle=True,
                                                                                           class_mode='categorical' )
...
image_gen = ImageDataGenerator(rescale=1.0/255.,
                               zoom_range=0.5).flow_from_directory(train_dir,batch_size=batch_size,target_size=IMG_SHAPE,
                                                                   shuffle=True,class_mode='categorical')

train_data_gen = ImageDataGenerator(rescale=1.0/255.,
                                    zoom_range=0.5).flow_from_directory(val_dir,batch_size=batch_size,target_size=IMG_SHAPE,
                                                                        shuffle=True,class_mode='categorical')
...
image_gen_train = ImageDataGenerator(rescale=1.0/255.,rotation_range=45,
                                     zoom_range=0.5,horizontal_flip=True,
                                     width_shift_range=0.15,
                                     height_shift_range=0.15)


train_data_gen = image_gen_train.flow_from_directory(train_dir,target_size=IMG_SHAPE,
                                         batch_size=batch_size,
                                         shuffle=True,
                                         class_mode='sparse')
...
val_data_gen = image_gen_val.flow_from_directory(val_dir,target_size=IMG_SHAPE,batch_size=batch_size,
                                                 class_mode='sparse')
...
model = tf.keras.Sequential([
                             layers.Conv2D(16,3,activation=tf.nn.relu,input_shape=(150,150,3)),
