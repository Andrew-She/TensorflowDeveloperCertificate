...
def vectorize_string(string):
  res = [char2idx[c] for c in string]
  print(res)
  return np.array(res)
...
def get_batch(vectorized_songs, seq_length, batch_size):
  ...
  #print(n,n-seq_length,idx, len(idx))
  '''TODO: construct a list of input sequences for the training batch'''
  input_batch = [vectorized_songs[c:c+seq_length] for c in idx]# TODO
  '''TODO: construct a list of output sequences for the training batch'''
  output_batch = [vectorized_songs[c+1:c+1+seq_length] for c in idx]# TODO
...
optimizer = tf.keras.optimizers.Adam(lr=learning_rate)# TODO
...
model.build(tf.TensorShape([128, 1]))
...
def generate_text(model, start_string, generation_length=1000):
  ...
  for i in tqdm(range(generation_length)):
      ...
      #print(np.array(input_eval))
  print(text_generated)
  #text_generated = [" ".join(item) for item in text_generated.astype(str)]
  return (start_string + ''.join(text_generated))

'''TODO: Use the model and the function defined above to generate ABC format text of length 1000!
    As you may notice, ABC files start with "X" - this may be a good start string.'''
generated_text = generate_text(model, start_string="X", generation_length=1000) # TODO
# generated_text = generate_text('''TODO''', start_string="A", generation_length=1000)
